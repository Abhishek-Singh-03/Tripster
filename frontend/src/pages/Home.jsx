...
const Home = () => {
  ...
  return (
    <div className='h-screen relative overflow-hidden'>
      ...
      <div className='flex flex-col justify-end h-screen absolute top-0 w-full'>
        <div className='h-[30%] p-6 bg-white relative'>
          ...
          <form onSubmit={(e) => {
            ...
            <input className='bg-[#eee] px-12 py-2 text-lg w-full rounded-lg mt-5'
              onClick={() => {
                setPanelOpen(true);
              }}
              type='text'
            ...
            />
            <input className='bg-[#eee] px-12 py-2 text-lg w-full rounded-lg mt-3'
              onClick={() => {
                setPanelOpen(true);
              }}
              type='text'
      ...
      <div ref={confirmRidePanelRef} className='fixed z-10 bottom-0 px-3 py-6 bg-white w-full translate-y-full pt-12'>
